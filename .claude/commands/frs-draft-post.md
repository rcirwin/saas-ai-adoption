...
The subagent reads `agents/voice-guide.md`, `agents/pillars.md`, and the `posts` tab of the FRS Google Sheet on its own. All validation, context, and drafting logic lives in `.claude/agents/frs-content-writer.md` — edit there, not here.
