...
export const faqContent = {
  ...
  items: [
    ...
    },
    {
      ...
      answer:
        "We sign a mutual NDA before kickoff. All work is conducted under strict confidentiality. We do not share findings, data, or artifacts with anyone outside the engagement. We can work within your existing security review process.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "The assessment is a one-time, fixed-scope engagement. Some teams choose to engage us for implementation advisory afterward, but there's no obligation. The artifacts are designed to be useful on their own.",
    },
    {
...
export const footerContent = {
  ...
  copyright: `© ${new Date().getFullYear()} SaaS AI Integration Planning`,
};
...
export const formConfig = {
  ...
  productTypes: [
    { value: "workflow", label: "Workflow / CRUD" },
